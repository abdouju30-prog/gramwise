...
- **Beta launch:** [`docs/BETA_LAUNCH.md`](./docs/BETA_LAUNCH.md) — URL + WhatsApp · app route `/beta`
- **Beta checklist:** [`docs/BETA_CHECKLIST.md`](./docs/BETA_CHECKLIST.md) — Stripe test only until legal entity.
