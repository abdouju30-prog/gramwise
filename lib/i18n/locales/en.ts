...
export const en: Messages = {
  ...
  recipe: {
    ...
    saveAndNew: "Save and new recipe",
    saveAndNewHint:
      "Stores on this device; optional JSON file — then clears the form.",
    savedToast: "Recipe saved to your library.",
    library: {
      expand: "My saved recipes",
      collapse: "Hide saved recipes",
      title: "Local recipe library",
      hint: "Stored in this browser on this computer. Export a .json file to disk and re-import later.",
      exportJson: "Download .json",
      saveToPc: "Save to my PC…",
      importJson: "Import .json",
      empty: "No saved recipes yet.",
      load: "Open",
      delete: "Delete",
      savedPicker: "File saved on your PC.",
      savedDownload: "File downloaded (Downloads folder).",
      saveError: "Could not save the file.",
      imported: (count) => `${count} recipe(s) imported.`,
