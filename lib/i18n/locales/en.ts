...
export const en: Messages = {
  ...
  start: {
    ...
    step1Desc: "Rent, utilities, insurance — monthly total",
    step2Title: "Recipe",
  ...
  fixed: {
    ...
    explainShort:
      "Step 1: monthly total. Step 2: for each recipe, say how many batches you make — the calculator spreads these costs.",
